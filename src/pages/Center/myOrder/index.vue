    ...
    <div class="order-right">
            ...
            <tbody>
                <tr v-for="(item1,index) in item.orderDetailList" :key="item1.id">
                    <td width="60%">
                        ...
                        <img style="width:100px;height:100px" :src="item1.imgUrl">
                    ...
                    <td :rowspan="item.orderDetailList.length" v-show="index ==0" width="13%" class="center">
                        <ul class="unstyled">
                        <li>总金额¥{{item.originalTotalAmount}}.00</li>
                        <li>在线支付</li>
        ...
        <!-- 分页器 -->
          <!-- 
           ...
           -->
           <!--  -->
           <Pagination  @updatePageNo="updatePageNo" :pageNo="Number(page)" 
                :pageSize="Number(limit)" 
                :total ="Number(myOrder.total)" 
                :continues="Number(5)">
            </Pagination>
        </div>
        <!--猜你喜欢-->
